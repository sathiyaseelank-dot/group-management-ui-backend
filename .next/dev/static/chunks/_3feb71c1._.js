...
async function getRemoteNetwork(networkId) {
    await delay();
    const network = MOCK_REMOTE_NETWORKS.find((n)=>n.id === networkId);
    const connectors = MOCK_CONNECTORS.filter((c)=>c.remoteNetworkId === networkId);
    const resources = MOCK_RESOURCES.filter((r)=>r.remoteNetworkId === networkId);
    return {
        network,
        connectors,
        resources
...
async function getConnector(connectorId) {
    await delay();
    const connector = MOCK_CONNECTORS.find((c)=>c.id === connectorId);
    const network = MOCK_REMOTE_NETWORKS.find((n)=>n.id === connector?.remoteNetworkId);
    // Mock some logs
    const logs = [
        {
            id: 1,
            timestamp: '2026-02-20 10:00:00',
            message: 'Connector service started'
        },
        {
            id: 2,
            timestamp: '2026-02-20 10:00:05',
            message: 'Successfully connected to the Twingate network'
        },
        {
            id: 3,
            timestamp: '2026-02-20 10:02:10',
            message: 'Authenticated with controller'
        }
    ];
    return {
        connector,
...
async function addResource(data) {
    ...
    const newResource = {
        ...
        ports: data.ports,
        alias: data.alias,
        description: `A new ${data.type.toLowerCase()} resource`,
        remoteNetworkId: data.network_id
    };
    MOCK_RESOURCES.push(newResource);
}
async function updateResource(resourceId, data) {
    await delay(150);
    MOCK_RESOURCES = MOCK_RESOURCES.map((res)=>{
...
async function addConnector(data) {
    ...
    const newConnector = {
        ...
        status: 'online',
        version: '1.0.0',
        hostname: `${data.name.toLowerCase().replace(/\s/g, '-')}.local`,
        remoteNetworkId: data.remoteNetworkId
    };
    MOCK_CONNECTORS.push(newConnector);
}
...
;
;
function NetworkConnectorsList({ connectors }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                children: [
...
;
;
function NetworkResourcesList({ resources }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                children: [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RemoteNetworkDetailPage.useEffect": ()=>{
            const loadNetworkData = {
                "RemoteNetworkDetailPage.useEffect.loadNetworkData": async ()=>{
                    try {
                        const { network, connectors, resources } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRemoteNetwork"])(networkId);
                        setNetwork(network);
            ...
            }["RemoteNetworkDetailPage.useEffect.loadNetworkData"];
            if (networkId) {
                loadNetworkData();
            }
        }
...
_s(RemoteNetworkDetailPage, "tw7+CkzYBn5dZv3rmNuv3gmhc08=", false, function() {
    return [
...
//# sourceMappingURL=_3feb71c1._.js.map